...
//        XLUtility excel = new XLUtility("C:\\Users\\ACER\\IdeaProjects\\Automation-Framework\\src\\TestData\\TestData.xlsx");
...
//    }
    ...
    public Object[][] twoDArray(String sheet) throws IOException {
        ...
        for(int i = 1;i<rowNum;i++){
            for(int j=0;j<cellNum;j++){
                data[i-1][0] = getCellData(sheet,i,j);
            }
        }
    ...
    public void setCellData(String sheetName,int rownum,int colnum, String data) throws IOException
    {
        ...
        if(workbook.getSheetIndex(sheetName) == -1) // If sheet not exists then create n
